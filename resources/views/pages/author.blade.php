	...
	<div class="container">
		<div class="listrecent listrelated">
				...
				<div class="authorpostbox">
					<div class="card">
						...
						<div class="card-block">
							<h2 class="card-title"><a href="{{Route('post' )}}">Life is worth living forever and ever</a></h2>
		    ...
		    <div class="authorpostbox">
		        ...
		        <div class="card-block">
		          <h2 class="card-title"><a href="{{Route('post' )}}">Best European capitals to visit and the costs implied</a></h2>
              <h4 class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</h4>
              <div class="metafooter">
		            <div class="wrapfooter">
		              <span class="meta-footer-thumb">
		    ...
		    <div class="authorpostbox">
		        ...
		        <div class="card-block">
		          <h2 class="card-title"><a href="{{Route('post' )}}">10 Things you should learn before visiting</a></h2>
              <h4 class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</h4>
              <div class="metafooter">
		            <div class="wrapfooter">
		              <span class="meta-footer-thumb">
